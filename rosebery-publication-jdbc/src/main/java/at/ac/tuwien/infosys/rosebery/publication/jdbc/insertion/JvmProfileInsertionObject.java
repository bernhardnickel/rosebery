...
import at.ac.tuwien.infosys.rosebery.publication.jdbc.dao.NodeDataAccessObject;
...
public class JvmProfileInsertionObject implements MeasurementInsertionObject<JvmProfile> {
    private static final String SQL = "INSERT INTO jvm_profile(node_id, timestamp, process_cpu_time, process_cpu_load_max, process_cpu_load_avg, process_cpu_load_min, system_cpu_load_max, system_cpu_load_avg, system_cpu_load_min, heap_max, heap_usage_max, heap_usage_avg, heap_usage_min) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public Long insert(JvmProfile jvmProfile) {
        ...
        try {
            ...
            pst.setLong(2, jvmProfile.getTimestamp());
